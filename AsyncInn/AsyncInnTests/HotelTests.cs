...
namespace AsyncInnTests
{
    public class HotelTests : DBTestBase
    {
        ...
        //[Fact]
        //public async Task CanReturnCorrectRoute()
        //{
        //    var controller = BuildHotelRepo();
        //    var routeString = controller.ToString();

        //    var route = HttpGetAttribute(controller.GetAllHotels());

        //    Assert.Equal("Hello", routeString);
        //}
    }
}